...
public class RegisterApp extends AsyncTask<Void, Void, String> {
	 ...
	 private void storeRegistrationId(Context ctx, String regid) {
	  final SharedPreferences prefs = ctx.getSharedPreferences(MenuActivity.class.getSimpleName(),
	 ...
	 private void sendRegistrationIdToBackend() {
	  URI url = null;
	  try {
	   url = new URI("http://210.107.197.242/register.php?regId=" + regid);
