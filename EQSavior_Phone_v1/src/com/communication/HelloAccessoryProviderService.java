...
public class HelloAccessoryProviderService extends SAAgent {
	...
	public class HelloAccessoryProviderConnection extends SASocket {
		...
		public void onReceive(int channelId, byte[] data) {
			...
			if(strToUpdateUI == "Settings") {
				// gear settings> telephone number
				// ex) message = "01084278467_01012341525"
				/*
				EditText editText_Family1 = (EditText)findViewById(R.id.editText_Family1);
				String string_Family1 = editText_Family1.getText().toString();
				
				EditText editText_Family2 = (EditText)findViewById(R.id.editText_Family2);
				String string_Family2 = editText_Family2.getText().toString();
				
				message = string_Family1.concat(string_Family2);
			...
			new Thread(new Runnable() {
				...
				public void run() {
					try {
						uHandler.send(HELLOACCESSORY_CHANNEL_ID, finalMessage.getBytes());
					} catch (IOException e) {
						e.printStackTrace();
					}
				}
