...
/**
 * A Phone sensing system senses various raw data.
 * It is supposed to give semantic to this data and to send it to the rule engine.
 * @author francois
 *
 */
public class SensingSystem implements LocationListener {
	...
	private void initBatterySensing() {
		...
		// we register our receiver to our context to receive battery information
	...
	// ----------------BEGIN GPS -------------- \\\\\\\\\\
	// Example:  http://androidexample.com/GPS_Basic__-__Android_Example/index.php?view=article_discription&aid=68&aaid=93

	private void initGPSSensing() {
		// create the location manager
		locationManager = (LocationManager) _context.getSystemService(Context.LOCATION_SERVICE);	
		//every 3 seconds, if the location is more than 5 meters different from previous spot
