...
public class Controller_Simulation {
	...
	private SimulationActivity __simulationInterface;
	...
	public Controller_Simulation(Context context) {
	...
	public void setSimulationInterface(SimulationActivity mf) {
		__simulationInterface = mf;
	}

	public void SetNewInformationFromUI(String intensity, boolean falling,
			boolean alarmDeactivated, boolean timeOut, String hearBeat) {
	...
	/*
	 * // display information to the view void displayInformation() {
	...
	public void setAlarmDeactivated() {
		...
		// the alarm has been started, and the rule engine just needs to know
	...
	/*
	 * public void stopReasoning() { __ruleEngine.set__inference_blocked(true);
	 * }
	 */
}
